                    ...
                    <TableBody>
                      {historyData[row.id]?.map((historyRow, idx) => (
                        ...
                        >
                          ...
                          <TableCell align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>
                            {historyRow.gs1_prefix}
                          </TableCell>
                          <TableCell align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>
                            {historyRow.gs2_prefix}
                          </TableCell>
                          <TableCell align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>
                            {historyRow.gs3_prefix}
                          </TableCell>
                          {config?.config?.esign_status === true && (
                            <StatusChip
...
const TableCompany = ({
  ...
  const handleChangeRowsPerPage = event => {
   ...
   const data = companyData?.data || [];
    ...
    setCompanyData(prev => ({ ...prev, data: sortedData }));
  ...
  const getData = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        setCompany({ data: res.data.data.companies, index: res.data.data.offset })
