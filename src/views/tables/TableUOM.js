                  ...
                  <Table size='small' aria-label='purchases'>
                    <TableHead>
                      <TableRow sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>
                        ...
                        <TableCell align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>Unit Of Measurement</TableCell>
                    ...
                    <TableBody>
                      {historyData[row.id]?.map((historyRow, idx) => (
                        <TableRow key={historyRow.created_at} align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>
                          ...
                          <TableCell align='center' sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)' }}>{historyRow.uom_name}</TableCell>
                          {config?.config?.esign_status === true && (
                            <StatusChip
