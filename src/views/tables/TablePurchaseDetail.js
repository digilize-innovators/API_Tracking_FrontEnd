...
import { Box, Table,  TableBody, TableRow, TableHead, TableCell, Typography, IconButton, Tooltip } from '@mui/material'
...
const TablePurchaseDetail = ({
  ...
  useEffect(() => {
    ...
    setOrderDetail(purchaseDetail.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage))
  }, [purchaseDetail, page, rowsPerPage])
