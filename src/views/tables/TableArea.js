...
const TableArea = ({ pendingAction, handleUpdate, setArea, apiAccess, config, handleAuthCheck, tableHeaderData }) => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setArea({ data: response.data.data.areas, index: response.data.data.offset })
      } else {
