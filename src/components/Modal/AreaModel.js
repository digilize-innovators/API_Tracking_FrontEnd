...
const AreaSchema = yup.object().shape({
  areaId: yup.string().trim().max(50, 'Area ID length should be less than 51').required("Area ID can't be empty"),
  areaName: yup
    .string()
    .trim()
      ...
      <Box sx={style}>
        ...
        <form onSubmit={handleSubmit(handleSubmitForm)}>
          <Grid2 container spacing={2}>
            <Grid2 size={6}>
              <CustomTextField name='areaId' label='Area ID *' control={control} disabled={!!editData?.id} />
            </Grid2>
            <Grid2 size={6}>
              <CustomTextField name='areaName' label='Area Name *' control={control} />
            </Grid2>
          </Grid2>
          <Grid2 container spacing={2}>
            <Grid2 size={6}>
            ...
            <Grid2 size={6}>
              <CustomDropdown name='location_uuid' label='Location *' control={control} options={allLocationsData} />
            </Grid2>
          </Grid2>
