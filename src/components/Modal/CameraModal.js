...
const validationSchema = yup.object().shape({
  name: yup
    .string()
    .trim()
    .min(3, 'Camera Name length should be greater than 3')
    .max(50, 'Camera Name length should be less than 50')
    .required("Camera Name can't be empty")
    .test('valid-camera-name', 'Control Panel Name cannot contain any special symbols', value => {
