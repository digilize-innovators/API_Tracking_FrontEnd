...
const UomSchema = yup.object().shape({
  unitName: yup
    ...
    .test('no-whitespace', 'Unit name cannot be just spaces', value => !!value && value.trim().length > 0)
})
      ...
      <Box sx={style}>
        ...
        <form onSubmit={handleSubmit(handleSubmitForm)}>
          <Grid2 container spacing={2}>
            <Grid2 xs={12} sm={6}>
              <CustomTextField name='unitName' label='Unit Of Measurement *' control={control} />
            </Grid2>
          </Grid2>
