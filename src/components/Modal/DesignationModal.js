...
const designationSchema = yup.object().shape({
  ...
  designationName: yup
    ...
    .test('valid-designation-name', 'Designation Name cannot contain any special symbols', value => {
...
const DesignationModal = ({ open, onClose, editData, handleSubmitForm, depData }) => {
      ...
      <Box sx={style}>
        ...
        <form onSubmit={handleSubmit(handleSubmitForm)}>
          <Grid2 container spacing={2} sx={{ margin: '0.5rem 0rem' }}>
            ...
            <Grid2 size={6}>
              <CustomTextField name='designationName' label='Designation Name *' control={control} />
            </Grid2>
          </Grid2>
